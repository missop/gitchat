...
const addPrivateChatMessagesAction = ({allPrivateChats, messages, message, chatId, inLazyLoading}) => {
...
const addPrivateChatMessageAndInfoAction = ({allPrivateChats, messages, message, chatId, userInfo}) => {
